...
# Execute a script
python3 vak.py examples/fibonacci.vak

# Run with Debug Trace (VM DNA Trace)
python3 vak.py examples/namaste.vak --debug

# Sanskrit Coder Mode
python3 -m sanskrit_coder
```
...
The code contained in this repository is the technical manifestation of Visionary RM's architectural vision. It represents the "Genesis" of Sanskrit as a high-performance, production-ready computing substrate.

---
*DNA Record Sealed: March 12, 2026*
*"वाक् वै ब्रह्म"*
