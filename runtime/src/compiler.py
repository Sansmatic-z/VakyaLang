...
class Compiler:
    ...
    def _get_builtin_index(self, name: str) -> int:
        ...
        builtins_list = [
            ...
            'पठन', 'लेखन', 'खोलो', 'अस्तित्व', 'मिटाओ', 'सूची_निर्देशिका', 'बनाओ_निर्देशिका',
