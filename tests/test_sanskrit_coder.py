...
# Import all modules
from sanskrit_coder.v_numbers.sanskrit_numbers import SanskritNumbers
...
class TestSanskritCoder:
    ...
    def test_numbers(self):
        ...
        try:
            assert self.v_numbers.to_sanskrit_digits("123") == "१२३", "Sanskrit digits failed"
            self.passed += 1
        ...
        try:
            assert self.v_numbers.to_arabic_digits("१२३") == "123", "Arabic digits failed"
            self.passed += 1
        ...
        # Test number words
        try:
            assert self.v_numbers.number_to_sanskrit(5) == "पञ्च", "Number word failed"
            self.passed += 1
        ...
        try:
            assert self.v_numbers.number_to_sanskrit(10) == "दश", "Number word failed"
            self.passed += 1
        ...
        try:
            result = self.v_numbers.parse_sanskrit_expression("५ प्लस ३")
